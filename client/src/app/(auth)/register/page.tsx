    ...
    <div className={authPage}>
      <div className={authCard}>
        <div className={authFormPanel}>
          <div className="mx-auto flex w-full max-w-85 flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1.5">
                <label className={authLabel}>Surname</label>
                <input
                  type="text"
                  required
                  minLength={2}
              ...
              <button type="submit" disabled={isAuthenticating} className={`${authSubmitBtn} mt-4`}>
                {isAuthenticating ? 'Creating account...' : 'Register Now'}
              </button>
            </form>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href={`${process.env.NEXT_PUBLIC_API_URL}/auth/google`} className={authGoogleBtn}>
